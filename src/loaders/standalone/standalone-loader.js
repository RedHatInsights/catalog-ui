...
import { catalogPaths } from './routes';
...
import { AboutModalBox } from '@patternfly/react-core/dist/js/components/AboutModal/AboutModalBox';
...
class App extends React.Component {
  ...
  render() {
    ...
    const Header = (
      <PageHeader
        ...
        headerTools={
          <PageHeaderTools>
            {!user ? (
              <Link to={catalogPaths.login}>Login</Link>
            ) : (
              <div>
                <StatefulDropdown
    ...
    if (this.props.location.pathname === catalogPaths.login) {
    ...
    return [
      menuSection('Products', {}, [
        ...
        menuItem('Order processes', {
          url: catalogPaths.order - processes
        }),
        menuItem('Orders', {
